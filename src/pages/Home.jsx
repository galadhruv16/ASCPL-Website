  ...
  const clientLogos = [
    {
      name: "ŠKODA",
      industry: "Automotive",
      logo: "/images/logos/skoda.png",
      logoClass: "logo-automotive",
    },
    {
      name: "Godrej",
      industry: "Consumer Goods",
      logo: "/images/logos/godrej.png",
      logoClass: "logo-manufacturing",
    },
    {
      name: "Siyaram's",
      industry: "Textile",
      logo: "/images/logos/siyarams.png",
      logoClass: "logo-textile",
    },
    {
      name: "HDFC ERGO",
      industry: "Insurance",
      logo: "/images/logos/hdfc-ergo.png",
      logoClass: "logo-insurance",
    },
    {
      name: "Volkswagen",
      industry: "Automotive",
    ...
    },
    {
      ...
      industry: "EPC",
      logo: "/images/logos/sterling-wilson.png",
      logoClass: "logo-manufacturing",
    },
    {
      name: "NPCI",
      industry: "FinTech",
      logo: "/images/logos/npci.png",
      logoClass: "logo-fintech",
    },
    {
      name: "Essar Power",
      industry: "Energy",
      logo: "/images/logos/essar-power.png",
      logoClass: "logo-energy",
    },
    {
      name: "Hotel Fidalgo",
      industry: "Hospitality",
      logo: "/images/logos/hotel-fidalgo.png",
      logoClass: "logo-healthcare",
    },
    {
      name: "Kaya Skin Clinic",
      industry: "Healthcare",
      logo: "/images/logos/kaya.png",
      logoClass: "logo-healthcare",
    },
    {
      name: "Drums Food",
      industry: "FMCG",
      logo: "/images/logos/drums-food.png",
      logoClass: "logo-manufacturing",
    },
    {
      name: "Fuchs",
      industry: "Chemical",
      logo: "/images/logos/fuchs.png",
      logoClass: "logo-manufacturing",
    },
    {
      name: "POSOCO",
      industry: "Power Grid",
      logo: "/images/logos/posoco.png",
      logoClass: "logo-energy",
    },
    {
      name: "Aureus Analytics",
      industry: "IT Services",
      logo: "/images/logos/aureus-analytics.png",
      logoClass: "logo-tech",
    },
    {
      name: "Mango Box",
      industry: "Retail",
      logo: "/images/logos/mango-box.png",
      logoClass: "logo-manufacturing",
    },
    {
      name: "SRS Pharmaceutical",
      industry: "Pharma",
      logo: "/images/logos/srs-pharmaceutical.png",
      logoClass: "logo-healthcare",
    },
    {
      name: "DNHPDCL",
      industry: "Power Distribution",
      logo: "/images/logos/dnhpdcl.png",
      logoClass: "logo-energy",
    },
    {
      name: "Writer Corporation",
      industry: "Manufacturing",
      logo: "/images/logos/writer-corporation.png",
      logoClass: "logo-manufacturing",
    },
  ];
          ...
          <div className="hero-content-advanced">
            ...
            <div className="hero-cta-container">
              <div className="cta-buttons-advanced">
                ...
                >
                  <span className="btn-text">Request a Consultation</span>
                  <span className="btn-icon">📞</span>
                  <div className="btn-ripple" />
                </Link>
                <a
                  ...
                  className="btn-modern btn-tertiary-modern group"
                >
                  <span className="btn-text">Download Company Profile</span>
                  <span className="btn-icon">📄</span>
                  <div className="btn-ripple" />
                </a>
              </div>
          ...
          <div className="client-carousel-premium">
            <div className="carousel-track">
              {[...clientLogos, ...clientLogos].map((client, index) => (
                <div
                  key={index}
                  className={`client-card-premium hover-float ${client.logoClass}`}
                >
