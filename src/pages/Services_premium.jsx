...
const Services = () => {
  ...
  const serviceCategories = {
    "management-systems": {
      ...
      icon: "🛡️",
      description:
        "Comprehensive ISO consulting across 15+ standards for operational excellence",
      gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
      services: [
        {
          name: "ISO 9001 (QMS)",
          description:
            "Quality Management System for process optimization and customer satisfaction",
          features: [
            "Process Mapping",
            "Document Control",
            "Internal Audits",
        ...
        },
        {
          name: "ISO 14001 (EMS)",
          description:
            "Environmental Management System for sustainability and compliance",
          features: [
    ...
    cybersecurity: {
      ...
      icon: "🔒",
      description:
        "Advanced security solutions protecting digital and operational assets",
    ...
    "ot-security": {
      ...
      icon: "⚙️",
      description:
        "Industrial control systems and operational technology protection",
      ...
      services: [
        ...
        },
        {
          ...
          description:
            "Real-time monitoring and incident response for OT environments",
          features: [
            "Network Monitoring",
            "Anomaly Detection",
            "Threat Hunting",
    ...
    "automotive-cyber": {
      ...
      icon: "🚗",
      description:
        "Specialized cybersecurity solutions for automotive industry",
    ...
    "ai-ml": {
      ...
      icon: "🤖",
      description:
        "Cutting-edge artificial intelligence solutions and training",
      gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
      services: [
        {
      ...
      services: [
        {
          ...
          description:
            "Standard Operating Procedures creation and optimization",
          features: [
        ...
        <div className="container-modern">
          ...
          >
            ...
            <p className="hero-description-modern">
              ACSPL delivers end-to-end consulting services across Management
              Systems, Cybersecurity, AI/ML, Regulatory Compliance, and Project
              Management. Our expert team ensures excellence in every
              engagement.
            </p>
            ...
            >
                ...
                {category.services.map((service, index) => (
                  <div key={index} className="service-card-detailed hover-lift">
                    <div className="service-card-header">
                      ...
                      <span className="service-benefit">
                        {service.benefits}
                      </span>
                    </div>
                    ...
                    <div className="service-actions">
                      ...
                      <button className="service-info-btn">Learn More</button>
                    </div>
              ...
              <div className="category-cta">
                <div className="cta-content">
                  ...
                  <p>
                    Contact our experts for a free consultation and customized
                    solution.
                  </p>
        ...
        <div className="container-modern">
          <div className="section-header-modern">
            ...
            <p className="section-description-modern">
              What sets ACSPL apart in delivering world-class consulting
              services
            </p>
          </div>
          ...
          <div className="excellence-grid">
            <div className="excellence-item hover-lift">
              ...
              <p>
                15+ years of deep industry knowledge across multiple verticals
                and standards
              </p>
            </div>
            ...
            <div className="excellence-item hover-lift">
              ...
              <p>
                Time-tested implementation frameworks ensuring successful
                project delivery
              </p>
            </div>
            ...
            <div className="excellence-item hover-lift">
              ...
              <p>
                Team of highly qualified consultants with international
                certifications
              </p>
            </div>
            ...
            <div className="excellence-item hover-lift">
              ...
              <p>
                Track record of delivering quantifiable business improvements
                and ROI
              </p>
            </div>
            ...
            <div className="excellence-item hover-lift">
              ...
              <p>
                24/7 ongoing support and maintenance ensuring sustained success
              </p>
            </div>
            ...
            <div className="excellence-item hover-lift">
              ...
              <p>
                Going beyond compliance to add strategic value to your business
                operations
              </p>
            </div>
          </div>
        ...
        <div className="container-modern">
          <div className="cta-content-premium">
            ...
            <p className="cta-description-premium">
              Every business is unique. Our experts will work with you to create
              a customized solution that addresses your specific challenges and
              goals.
            </p>
